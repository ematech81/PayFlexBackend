...
const startServer = async () => {
  try {
    ...
    // CAC registration routes carry up to 6 base64 images (~8 MB); they need a
    // higher limit than the global default. Register the larger parser first so
    // it takes precedence for those paths.
